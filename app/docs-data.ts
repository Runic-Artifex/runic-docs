...
export const products: Product[] = [
  {
    ...
    version: "0.1.0-preview.19.1", source: "https://github.com/Runic-Artifex/runic-toolkit",
    ...
    install: ["dotnet add package RunicToolkit.Hosting.CsWebUi.ApplicationBridge --version 0.1.0-preview.19.1", "npm install @runic-artifex/application-bridge@0.1.0-preview.19.1 effect@3.22.1"],
  },
  {
